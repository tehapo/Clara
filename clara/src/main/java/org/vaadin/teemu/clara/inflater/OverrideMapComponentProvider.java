...
public class OverrideMapComponentProvider implements ComponentProvider {
   ...
   * Constructor.
   *
   * @param componentOverrideMap the map with component instances to lookup by id.
   */
  public OverrideMapComponentProvider(Map<String, Component> componentOverrideMap) {
